...
class TestActorConfig(unittest.TestCase):
    ...
    def test_actor_config_from_yaml(self):
        ...
        self.assertIsInstance(config, DiffusionActorConfig)
    ...
    def test_fsdp_actor_config_from_yaml(self):
        ...
        self.assertIsInstance(config, DiffusionFSDPActorConfig)
    ...
    #     self.assertIsInstance(config, DiffusionMcoreActorConfig)
